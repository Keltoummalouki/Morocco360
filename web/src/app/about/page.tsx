...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'EventHub is the ticketing platform for events across Morocco.',
};
...
export default function AboutPage() {
  return (
    ...
    >
      <p>
        EventHub connects locals and travellers with concerts, festivals, sport, food and
